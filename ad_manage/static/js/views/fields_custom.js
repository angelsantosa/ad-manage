;(function (define, undefined) {
    ...
    define([
        ...
        'text!templates/fields_custom/field_readonly.underscore',
        'text!templates/fields_custom/field_dropdown.underscore',
        'text!templates/fields_custom/field_link.underscore',
        'text!templates/fields_custom/field_link_social_network.underscore',
        'text!templates/fields_custom/field_text.underscore',
        'text!templates/fields_custom/field_textarea.underscore',
        'backbone-super'
    ], function (gettext, $, _, Backbone,
                 field_readonly_template,
                 field_dropdown_template,
                 field_link_template,
                 field_link_social_network_template,
                 field_text_template,
        ...
        FieldViews.DropdownFieldView = FieldViews.EditableFieldView.extend({
            ...
            fieldValue: function () {
                ...
                if (this.editable === 'never') {
                    ...
                    value = this.$('.u-field-custom-value select').val();
                }
            ...
            updateValueInField: function () {
                if (this.editable !== 'never') {
                    this.$('.u-field-custom-value select').val(this.modelValue() || '');
                }
                ...
                this.$('.u-field-custom-value').attr('aria-label', this.options.title);
                this.$('.u-field-custom-value-readonly').html(_.escape(value));
            ...
            showDisplayMode: function(render) {
                this._super(render);
                if (this.editable === 'toggle') {
                    this.$('.u-field-custom-value a').focus();
                }
            },
            ...
            showEditMode: function(render) {
                this._super(render);
                if (this.editable === 'toggle') {
                    this.$('.u-field-custom-value select').focus();
                }
            },
            ...
            disableField: function(disable) {
                if (this.editable !== 'never') {
                    this.$('.u-field-custom-value select').prop('disabled', disable);
                }
            }
        });
        ...
        FieldViews.TextareaFieldView = FieldViews.EditableFieldView.extend({
            ...
            events: {
                'click .wrapper-u-field-custom': 'startEditing',
                'click .u-field-custom-placeholder': 'startEditing',
                'focusout textarea': 'finishEditing',
                'focus textarea': 'adjustTextareaHeight',
            ...
            onKeyDown: function (event) {
            	/* Casualy calling to the beast  3:> */
                if (event.keyCode === 666) {
            ...
            fieldValue: function () {
                if (this.mode === 'edit') {
                    return this.$('.u-field-custom-value textarea').val();
                }
                else {
                    return this.$('.u-field-custom-value .u-field-custom-value-readonly').text();
                }
            },
            ...
            showEditMode: function(render) {
                this._super(render);
                this.adjustTextareaHeight();
                this.$('.u-field-custom-value textarea').focus();
            },
        ...
        FieldViews.LinkSocialNetworkFieldView = FieldViews.FieldView.extend({

            fieldType: 'link',

            fieldTemplate: field_link_social_network_template,
            ...
            render: function () {
                this.$el.html(this.template({
                    ...
                    screenReaderTitle: this.options.screenReaderTitle || this.options.title,
                    linkTitle: this.options.linkTitle,
                    linkIcon: this.options.linkIcon,
                    linkHref: this.options.linkHref,
                    message: this.helpMessage
                }));
                this.delegateEvents();
