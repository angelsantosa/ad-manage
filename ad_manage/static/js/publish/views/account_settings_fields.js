...
;(function (define, undefined) {
    ...
    define([
        ...
        'js/views/fields_custom', 'js/views/file_uploader_field',
        'jquery.fileupload'
    ], function (gettext, $, _, Backbone, FieldViews, FileUploaderView) {
        ...
        AccountSettingsFieldViews.AuthSocialNetworkFieldView = FieldViews.LinkSocialNetworkFieldView.extend({
        ...
        AccountSettingsFieldViews.FileUploadFieldView = FileUploaderView.extend({
